...
-  [[file:///home/lox/study/ffmpeg/ffmpeg.html#sec-7][7
   ffmpegthumbnailer截取视频的thumbnail]]
...
-  -aspect aspect: 设定aspect ratio(4:3, 16:9, 30:9, 1:3 or 1.333, 1.777
   etc.)
...
-  -vf filter\_graph
-  -vf
   pad=width:height:x:y:color(这个命令可以给裁剪后的视频增加上下两个pad，形成电影似的效果)
...
** 8 [[http://www.youku.com/][Youku]]的一些探索
   :PROPERTIES:
   :CUSTOM_ID: sec-8
   :END:
